...
def create_optimizer_from_config(optimizer_config, parameters):
    ...
    """
    print("DEBUG: Trainable parameters:", sum(p.requires_grad for p in parameters))
    ...
    for i, g in enumerate(optimizer.param_groups):
        print("DEBUG: Param group", i, "LR:", g["lr"])
    return optimizer
...
def create_scheduler_from_config(scheduler_config, optimizer):
    ...
    print("DEBUG: Scheduler initial LR:", scheduler.get_last_lr())
